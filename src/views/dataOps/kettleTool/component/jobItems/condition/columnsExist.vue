                ...
                <el-form :model="form" label-width="100px">
                    ...
                    <el-tabs type="border-card" v-model="activeTab" class="tabItem">
                        <el-form label-position="right" label-width="150px">
                            ...
                            <el-divider content-position="left">数据表字段</el-divider>
                            <RightClickTable ref="fileTableRef" v-model="form.fields" :columns="fileDataColumns"
                                ...
                                @parent-function="getTableFields">
                            </RightClickTable>
                        </el-form>
                    </el-tabs>
                </el-form>
...
const parseStepInfoAndPopulateForm = (stepInfoXml) => {
    try {
        ...
        if (stepElements.length > 0) {
            ...
            form.fields = JSON.parse(columnsExits.getAttribute('fields') || '[]');
        }
    } catch (error) {
...
const updateStepInfoXml = (stepInfoXml) => {
    try {
        ...
        if (stepElements.length > 0) {
            ...
            columnsExits.setAttribute("fields", JSON.stringify(form.fields));
            // 返回更新后的XML
