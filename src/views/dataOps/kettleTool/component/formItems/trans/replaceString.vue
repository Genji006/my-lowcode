...
const fieldDataColumns = computed(() => [
  {
    ...
    label: "输入流字段",
    type: "select",
    options: nameColumnList.value,
    valueKey: "name",
    labelKey: "name",
  },
  { prop: "out_stream_name", label: "输出流字段", width: 120 },
  {
    prop: "use_regex",
    label: "使用正则表达式",
    width: 140,
  ...
  { prop: "replace_string", label: "搜索", width: 120 },
  { prop: "replace_by_string", label: "使用...替换", width: 120 },
  {
...
const getNameColumnListFn = async () => {
  let params = {
    stepName: stepName.value,
    graphXml: allXml,
    before: true,
