    ...
    <div class="config-panel">
        ...
        <div v-else>
            ...
            <el-form label-width="100px" label-position="right">
                ...
                <el-form-item label="高度 (%)" v-if="!activeComp.style.isAutoFill">
                    <div style="display: flex; width: 100%; gap: 5px;">
                        <el-input-number v-model="activeHeight" :min="0" :max="100" controls-position="right"
...
const configMap = {
    ...
    'MyChart': MyChartConfig, // 柱状图、折线图
    'MyScatterChart': MyChartConfig,// 散点图
