<template>
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      ...
      <el-button size="mini" type="primary" :icon="Plus" @click="openModel('message')">创建新消息</el-button>
    </div>
    ...
    <div class="panel-tab__content--title" style="padding-top: 8px; margin-top: 8px; border-top: 1px solid #eeeeee">
      ...
      <el-button size="mini" type="primary" :icon="Plus" @click="openModel('signal')">创建新信号</el-button>
    </div>
