...
/**
 * Helper function to check if an event has a specific type and definition
 * @param {Object} eventBo - Event business object
 * @param {string} type - Event type
 * @param {string} definition - Event definition type
